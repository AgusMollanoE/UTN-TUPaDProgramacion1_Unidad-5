...
opcion = input("Que accion desea realizar? (agregar/eliminar): ").lower().strip()

# opcion para agregar un nuevo estudiante a la lista
if opcion == "agregar":
    nuevo_estudiante = input("Ingrese el nombre del Estudiante: ").lower().strip()
    estudiantes.append(nuevo_estudiante)
    print(f"Estudiante {nuevo_estudiante} agregado a la lista.")
#opcion para eliminar un estudiante de la lista    
elif opcion == "eliminar":
    eliminar_estudiante = input("Ingrese el nombre que desea eliminar: ").lower().strip()
