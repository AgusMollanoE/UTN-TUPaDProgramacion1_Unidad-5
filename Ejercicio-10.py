...
print("----------El producto más vendido en la semana----------")
max_producto = max(totales_productos)
posicion_prod_max = totales_productos.index(max_producto)
print(f"El producto mas Vendido fue: {productos[posicion_prod_max]} con {max_producto} de Undidades")
...
print(f"El día con mayores ventas totales fue: {dias[posicion_dia_max]} con {max_dia} de Undidades")